...
from app.main import build_pipeline_summary


class PipelineCliSummaryTest(unittest.TestCase):
    def test_build_pipeline_summary_reports_final_status(self) -> None:
